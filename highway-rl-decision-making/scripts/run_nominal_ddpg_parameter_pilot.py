...
def pilot_config_payload(
    *,
    ...
    source_paths = {
        ...
        "pipeline_runner": project_root / "scripts" / "run_cbf_filter_ablation.py",
        "script_config": project_root / "scripts" / "laneless_script_config.py",
        "mtm_training_config": project_root / "scripts" / "train_safety_potential_variants.py",
